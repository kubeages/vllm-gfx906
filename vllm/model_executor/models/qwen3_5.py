...
# Stub for _require_is_multimodal — not present in vllm 0.12.0 base.
# Qwen3.5 text-only models never reach the multimodal code path.
try:
    from .interfaces import _require_is_multimodal
except ImportError:
    def _require_is_multimodal(is_multimodal):  # type: ignore[misc]
...
class Qwen3_5ForCausalLMBase(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # mamba_cache_mode was added after vllm 0.12.0 — use getattr for compat
